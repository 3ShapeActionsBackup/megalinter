...
FROM python:3.13.4-alpine3.21 AS build-ml-core
WORKDIR /
...
ARG NPM_SALESFORCE_CLI_VERSION=2.91.6
# renovate: datasource=npm depName=@salesforce/plugin-packaging
ARG NPM_SALESFORCE_PLUGIN_PACKAGING_VERSION=2.15.3
...
ARG PIP_CFN_LINT_VERSION=1.35.4
...
ARG NPM_ESLINT_PLUGIN_PRETTIER_VERSION=5.4.1
...
# renovate: datasource=github-tags depName=aquasecurity/trivy
ARG REPOSITORY_TRIVY_SBOM_VERSION=0.62.1
...
ARG GEM_RUBOCOP_VERSION=1.75.8
...
ARG LIGHTNING_FLOW_SCANNER_VERSION=3.16.1
